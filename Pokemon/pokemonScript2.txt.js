...
/*Function that takes pokemon’s name as an argument and find out
which all pokemon have that name in their “next_evolution” field*/
var pokemonNextEvolution = function(pokemonName, pokemonList)
{
var nextEvolutionList = [] //Array storing all those pokemons which have inputted name in their “next_evolution” field
var pokemonInNextEvolution = false; //Boolean flag to indicate whether pokemon exists in next_evolution or not

//Looping through the pokemon Array of Objects
for(var pokemonIterator in pokemonList)
	{  
  //Looping through the next_evolution Array of Objects
  for(var nextEvolutionIterator in pokemonList[pokemonIterator].next_evolution)
  {
  	if(pokemonName == pokemonList[pokemonIterator].next_evolution[nextEvolutionIterator].name)
  	{
    console.log(pokemonList[pokemonIterator].next_evolution)
    console.log(pokemonList[pokemonIterator].next_evolution[nextEvolutionIterator].name + Number(Number(nextEvolutionIterator)+1))
    console.log(pokemonList[pokemonIterator].name)
    
    pokemonInNextEvolution = true
    //Adding the found pokemon name to the Array
    nextEvolutionList.push(pokemonList[pokemonIterator].name)
    break
    }
  else
   	{ //Do nothing 
...
if(pokemonInNextEvolution == true)
{return nextEvolutionList}
else
{alert("Pokemon not found in Next Evolution")
//Displaying message if entered pokemon not found and exiting the program
exit()}
}

//Gathering user input for pokemon name
var enterPokemon = prompt('Enter the Next evoluted Pokemon name')

/*Function call taking pokemon’s name as argument and collecting all those pokemons which have inputted name in their “next_evolution” field in an Array and displaying it*/
var nextEvolutionPokemonList = pokemonNextEvolution(enterPokemon,pokemon)
alert("Pokemons having "+enterPokemon+" in their next_evolution field are : "+nextEvolutionPokemonList)