...
/*Function that takes Weakness as an input and gives the names
of all pokemon who have that Weakness*/
var pokemonWeakness = function(weakness, pokemonList)
{
var weaknessList = [] //Array storing all those pokemons which have inputted weakness
var weaknessExists = false; //Boolean flag to indicate whether weakness exists or not

//Looping through the pokemon Array of Objects
for(var pokemonIterator in pokemonList)
	{  
  //Looping through the weakness Array
  for(var weaknessIterator in pokemonList[pokemonIterator].weaknesses)
  {
  	if(weakness == pokemonList[pokemonIterator].weaknesses[weaknessIterator])
  	{
    //console.log(pokemonList[pokemonIterator].weaknesses); console.log(pokemonList[pokemonIterator].weaknesses[weaknessIterator]+Number(Number(weaknessIterator)+1))
		weaknessExists = true
    //Adding the found pokemon name to the Array
    weaknessList.push(pokemonList[pokemonIterator].name)
    break
    }
  else
   	{ //Do nothing 
...
if(weaknessExists == true)
{return weaknessList}
else
{alert("This Weakness not found for any Pokemon")
//Displaying message if entered weakness not found and exiting the program
exit()}
}

//Gathering user input for pokemon weakness
var enterWeakness = prompt('Enter the Weakness of Pokemon')

/*Function call taking Weakness as an input and gives the names
of all pokemon who have that Weakness in an Array and displaying it*/
var pokemonWeaknessList = pokemonWeakness(enterWeakness,pokemon)
alert("Pokemons having "+enterWeakness+" as Weakness are : "+pokemonWeaknessList)
console.log("Pokemons having "+enterWeakness+" as Weakness are : "+pokemonWeaknessList)