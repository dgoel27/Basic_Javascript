//Defining variable to store the Json Data (Array of Objects)
...
/*Function to take pokemon’s name as argument and display the
information of that pokemon*/

var pokemonDetails = function(pokemonName, pokemonList)
{

//Boolean flag to indicate whether pokemon exists or not
var pokemonFound = false;

//Looping through the pokemon Array of Objects
for(var pokemonIterator in pokemonList)
	{
  if(pokemonName == pokemonList[pokemonIterator].name)
  	{
		pokemonFound = true
    alert(pokemonList[pokemonIterator].name)
		console.log(pokemonList[pokemonIterator])
    break
    }
  else
   	{//Do nothing 
...
//Displaying message if entered pokemon not found}
return
}
}
//Gathering user input for pokemon name
var enterPokemon = prompt('Enter the pokemon name')

/*Function call taking pokemon’s name as argument and displaying the
information of that pokemon*/
pokemonDetails(enterPokemon,pokemon)